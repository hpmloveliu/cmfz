    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {//点击更换验证码
                $("#captchaImage").prop("src", "${pageContext.request.contextPath}/code/createCode?time=" + new Date());
            });
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    ...
                    <img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/code/createCode"
                         title="点击更换验证码"/>
                </td>
            </tr>
            <tr>
